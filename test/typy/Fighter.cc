...
int Fighter::Visit(visitproc visit, void* arg) {
	register int result = 0;
	if((result = ::typy::Visit(p_bd, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_bl, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_dd, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_dv, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_ed, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_el, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_fdd, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_fdv, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_fl, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_fld, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_flv, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_hp, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_isAwake, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_ld, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_ll, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_lv, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_nv, visit, arg)) != 0) { return result; }
	...
	if((result = ::typy::Visit(p_v0, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_v1, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_v2, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_v3, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_v4, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_vd, visit, arg)) != 0) { return result; }
	if((result = ::typy::Visit(p_vl, visit, arg)) != 0) { return result; }
	return result;
}
...
void Fighter::SerializeWithCachedSizes(CodedOutputStream* output) const {
	...
	::typy::Write(21, p_posll, output);
	::typy::Write(22, p_poss, output);
	::typy::Write(23, p_pyd, output);
	::typy::Write(24, p_pyl, output);
	::typy::Write(25, p_pyv1, output);
	::typy::Write(26, p_pyv2, output);
	::typy::Write(27, p_sd, output);
	::typy::Write(28, p_sl, output);
	::typy::Write(29, p_v0, output);
	::typy::Write(30, p_v1, output);
	::typy::Write(31, p_v2, output);
	::typy::Write(32, p_v3, output);
	::typy::Write(33, p_v4, output);
	::typy::Write(34, p_vd, output);
	::typy::Write(35, p_vl, output);
}
...
int Fighter::ByteSize() const {
	...
	::typy::ByteSize(total_size, 2, p_posll);
	...
	::typy::ByteSize(total_size, 2, p_v0);
...
bool Fighter::MergePartialFromCodedStream(CodedInputStream* input) {
	...
	NEXT_READ_REPEATED_OBJECT_CASE(5, p_ed, SINGLE_ARG(Dict<int64, Corpus >)::Entry, PREV_NO_REPEATED_OBJECT, NEXT_NO_REPEATED_OBJECT)
	...
	NEXT_READ_NORMAL_CASE(8, p_fdv, ViDif)
	...
	NEXT_READ_REPEATED_OBJECT_CASE(21, p_posll, VLVector2, PREV_IS_REPEATED_OBJECT, NEXT_IS_REPEATED_OBJECT)
	NEXT_READ_REPEATED_OBJECT_CASE(22, p_poss, SINGLE_ARG(Dict<int64, Vector2 >)::Entry, PREV_IS_REPEATED_OBJECT, NEXT_IS_REPEATED_OBJECT)
	NEXT_READ_REPEATED_OBJECT_CASE(23, p_pyd, SINGLE_ARG(Dict<int32, Python<Shadow_PyType> >)::Entry, PREV_IS_REPEATED_OBJECT, NEXT_IS_REPEATED_OBJECT)
	NEXT_READ_REPEATED_OBJECT_CASE(24, p_pyl, Python<Shadow_PyType>, PREV_IS_REPEATED_OBJECT, NEXT_NO_REPEATED_OBJECT)
	NEXT_READ_NORMAL_CASE(25, p_pyv1, ViPyType)
	NEXT_READ_NORMAL_CASE(26, p_pyv2, ViPyType)
	NEXT_READ_REPEATED_OBJECT_CASE(27, p_sd, SINGLE_ARG(Dict<int32, string >)::Entry, PREV_NO_REPEATED_OBJECT, NEXT_NO_REPEATED_OBJECT)
	NEXT_READ_NORMAL_CASE(28, p_sl, string)
	NEXT_READ_NORMAL_CASE(29, p_v0, VbyfiVector2)
	NEXT_READ_NORMAL_CASE(30, p_v1, VbyfiVector2)
	NEXT_READ_NORMAL_CASE(31, p_v2, VfisVector2)
	NEXT_READ_NORMAL_CASE(32, p_v3, VfisVector2)
	NEXT_READ_NORMAL_CASE(33, p_v4, VfisVector2)
	NEXT_READ_REPEATED_OBJECT_CASE(34, p_vd, SINGLE_ARG(Dict<int32, VdesVector2 >)::Entry, PREV_NO_REPEATED_OBJECT, NEXT_IS_REPEATED_OBJECT)
	NEXT_READ_REPEATED_OBJECT_CASE(35, p_vl, VfpisVector2, PREV_IS_REPEATED_OBJECT, NEXT_NO_REPEATED_OBJECT)
	END_READ_CASE()
}
...
PyObject* Fighter::Json(bool slim) {
	...
	if (value != NULL) { PyDict_SetItemString(json, "dd", value); Py_DECREF(value); }
	value = ::typy::Json(p_dv, slim);
	if (value != NULL) { PyDict_SetItemString(json, "dv", value); Py_DECREF(value); }
	...
	if (value != NULL) { PyDict_SetItemString(json, "fdd", value); Py_DECREF(value); }
	value = ::typy::Json(p_fdv, slim);
	if (value != NULL) { PyDict_SetItemString(json, "fdv", value); Py_DECREF(value); }
	value = ::typy::Json(p_fl, slim);
	if (value != NULL) { PyDict_SetItemString(json, "fl", value); Py_DECREF(value); }
	value = ::typy::Json(p_fld, slim);
	if (value != NULL) { PyDict_SetItemString(json, "fld", value); Py_DECREF(value); }
	value = ::typy::Json(p_flv, slim);
	if (value != NULL) { PyDict_SetItemString(json, "flv", value); Py_DECREF(value); }
	...
	if (value != NULL) { PyDict_SetItemString(json, "ld", value); Py_DECREF(value); }
	value = ::typy::Json(p_ll, slim);
	if (value != NULL) { PyDict_SetItemString(json, "ll", value); Py_DECREF(value); }
	value = ::typy::Json(p_lv, slim);
	if (value != NULL) { PyDict_SetItemString(json, "lv", value); Py_DECREF(value); }
	value = ::typy::Json(p_nv, slim);
	if (value != NULL) { PyDict_SetItemString(json, "nv", value); Py_DECREF(value); }
	...
	value = ::typy::Json(p_v0, slim);
	if (value != NULL) { PyDict_SetItemString(json, "v0", value); Py_DECREF(value); }
	value = ::typy::Json(p_v1, slim);
	if (value != NULL) { PyDict_SetItemString(json, "v1", value); Py_DECREF(value); }
	value = ::typy::Json(p_v2, slim);
	if (value != NULL) { PyDict_SetItemString(json, "v2", value); Py_DECREF(value); }
	value = ::typy::Json(p_v3, slim);
	if (value != NULL) { PyDict_SetItemString(json, "v3", value); Py_DECREF(value); }
	value = ::typy::Json(p_v4, slim);
	if (value != NULL) { PyDict_SetItemString(json, "v4", value); Py_DECREF(value); }
	value = ::typy::Json(p_vd, slim);
	if (value != NULL) { PyDict_SetItemString(json, "vd", value); Py_DECREF(value); }
	value = ::typy::Json(p_vl, slim);
	if (value != NULL) { PyDict_SetItemString(json, "vl", value); Py_DECREF(value); }
	return json;
}
...
Fighter* Fighter::FromJson(PyObject* json) {
	...
	if (strcmp(PyBytes_AS_STRING(value), Fighter::Name)) {
	...
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("dd")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_dd, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("dv")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_dv, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	...
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("fdd")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_fdd, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("fdv")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_fdv, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	...
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("fld")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_fld, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("flv")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_flv, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	...
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("ld")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_ld, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	...
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("lv")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_lv, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("nv")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_nv, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	...
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("v0")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_v0, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("v1")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_v1, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("v2")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_v2, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("v3")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_v3, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("v4")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_v4, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("vd")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_vd, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	value = PyObject_GetItem(json, ScopedPyObjectPtr(PyString_FromString("vl")).get()); PyErr_Clear();
	if (value != NULL) { if (!::typy::FromJson(object->p_vl, value)) { Py_DECREF(value); return NULL; } Py_DECREF(value); }
	return object;
}

// ===================================================================

const int Fighter::PropertyCount = 35;
...
int Fighter::PropertyByteSize(int tag) const {
	...
	case 21: ::typy::ByteSize(size, 2, p_posll); if (size == 0) { size = 2; } break;
	case 22: ::typy::ByteSize(size, 2, p_poss); if (size == 0) { size = 2; } break;
	case 23: ::typy::ByteSize(size, 2, p_pyd); if (size == 0) { size = 2; } break;
	case 24: ::typy::ByteSize(size, 2, p_pyl); if (size == 0) { size = 2; } break;
	case 25: ::typy::ByteSize(size, 2, p_pyv1); if (size == 0) { size = 2; } break;
	case 26: ::typy::ByteSize(size, 2, p_pyv2); if (size == 0) { size = 2; } break;
	case 27: ::typy::ByteSize(size, 2, p_sd); if (size == 0) { size = 2; } break;
	case 28: ::typy::ByteSize(size, 2, p_sl); if (size == 0) { size = 2; } break;
	case 29: ::typy::ByteSize(size, 2, p_v0); if (size == 0) { size = 2; } break;
	case 30: ::typy::ByteSize(size, 2, p_v1); if (size == 0) { size = 2; } break;
	case 31: ::typy::ByteSize(size, 2, p_v2); if (size == 0) { size = 2; } break;
	case 32: ::typy::ByteSize(size, 2, p_v3); if (size == 0) { size = 2; } break;
	case 33: ::typy::ByteSize(size, 2, p_v4); if (size == 0) { size = 2; } break;
	case 34: ::typy::ByteSize(size, 2, p_vd); if (size == 0) { size = 2; } break;
	case 35: ::typy::ByteSize(size, 2, p_vl); if (size == 0) { size = 2; } break;
	}
	return size;
}
...
void Fighter::SerializeProperty(CodedOutputStream* output, int tag) const {
	...
	case 21:
		::typy::Write(21, p_posll, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(21, p_posll, output);
		}
		break;
	case 22:
		::typy::Write(22, p_poss, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(22, p_poss, output);
		}
		break;
	case 23:
		::typy::Write(23, p_pyd, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(23, p_pyd, output);
		}
		break;
	case 24:
		::typy::Write(24, p_pyl, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(24, p_pyl, output);
		}
		break;
	case 25:
		::typy::Write(25, p_pyv1, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(25, p_pyv1, output);
		}
		break;
	case 26:
		::typy::Write(26, p_pyv2, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(26, p_pyv2, output);
		}
		break;
	case 27:
		::typy::Write(27, p_sd, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(27, p_sd, output);
		}
		break;
	case 28:
		::typy::Write(28, p_sl, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(28, p_sl, output);
		}
		break;
	case 29:
		::typy::Write(29, p_v0, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(29, p_v0, output);
		}
		break;
	case 30:
		::typy::Write(30, p_v1, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(30, p_v1, output);
		}
		break;
	case 31:
		::typy::Write(31, p_v2, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(31, p_v2, output);
		}
		break;
	case 32:
		::typy::Write(32, p_v3, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(32, p_v3, output);
		}
		break;
	case 33:
		::typy::Write(33, p_v4, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(33, p_v4, output);
		}
		break;
	case 34:
		::typy::Write(34, p_vd, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(34, p_vd, output);
		}
		break;
	case 35:
		::typy::Write(35, p_vl, output);
		if (output->ByteCount() <= 0) {
			::typy::WriteTag(35, p_vl, output);
		}
		break;
	}
}
...
int Fighter::DeserializeProperty(CodedInputStream* input) {
	...
	case 21: ::typy::Clear(p_posll); break;
	case 22: ::typy::Clear(p_poss); break;
	case 23: ::typy::Clear(p_pyd); break;
	case 24: ::typy::Clear(p_pyl); break;
	case 25: ::typy::Clear(p_pyv1); break;
	case 26: ::typy::Clear(p_pyv2); break;
	case 27: ::typy::Clear(p_sd); break;
	case 28: ::typy::Clear(p_sl); break;
	case 29: ::typy::Clear(p_v0); break;
	case 30: ::typy::Clear(p_v1); break;
	case 31: ::typy::Clear(p_v2); break;
	case 32: ::typy::Clear(p_v3); break;
	case 33: ::typy::Clear(p_v4); break;
	case 34: ::typy::Clear(p_vd); break;
	case 35: ::typy::Clear(p_vl); break;
	}
...
bool Fighter::SetPropertySequence(PyObject* args) {
	for (Py_ssize_t i = 0; i < PyTuple_GET_SIZE(args); i++) {
		...
		case 4: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 4), p_ed, "Property 'ed' expect Dict(int64 -> Corpus), but ")) { return false; } break;
		...
		case 20: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 20), p_posll, "Property 'posll' expect List(VLVector2), but ")) { return false; } break;
		case 21: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 21), p_poss, "Property 'poss' expect Dict(int64 -> Vector2), but ")) { return false; } break;
		case 22: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 22), p_pyd, "Property 'pyd' expect Dict(int32 -> Python<Shadow_PyType>), but ")) { return false; } break;
		case 23: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 23), p_pyl, "Property 'pyl' expect List(Python<Shadow_PyType>), but ")) { return false; } break;
		case 24: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 24), p_pyv1, "Property 'pyv1' expect Variant(Integer, PyType), but ")) { return false; } break;
		case 25: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 25), p_pyv2, "Property 'pyv2' expect Variant(Integer, PyType), but ")) { return false; } break;
		case 26: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 26), p_sd, "Property 'sd' expect Dict(int32 -> string), but ")) { return false; } break;
		case 27: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 27), p_sl, "Property 'sl' expect List(string), but ")) { return false; } break;
		case 28: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 28), p_v0, "Property 'v0' expect Variant(Integer, Vector2, Float, Bytes), but ")) { return false; } break;
		case 29: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 29), p_v1, "Property 'v1' expect Variant(Integer, Vector2, Float, Bytes), but ")) { return false; } break;
		case 30: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 30), p_v2, "Property 'v2' expect Variant(Integer, Vector2, Float, String), but ")) { return false; } break;
		case 31: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 31), p_v3, "Property 'v3' expect Variant(Integer, Vector2, Float, String), but ")) { return false; } break;
		case 32: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 32), p_v4, "Property 'v4' expect Variant(Integer, Vector2, Float, String), but ")) { return false; } break;
		case 33: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 33), p_vd, "Property 'vd' expect Dict(int32 -> VdesVector2), but ")) { return false; } break;
		case 34: if (!::typy::CheckAndSet(PyTuple_GET_ITEM(args, 34), p_vl, "Property 'vl' expect List(VfpisVector2), but ")) { return false; } break;
...
PyObject* Fighter::GetPropertySequence() {
	PyObject* result = PyTuple_New(35);
	...
	PyTuple_SET_ITEM(result, 20, ::typy::GetPyObject(p_posll));
	PyTuple_SET_ITEM(result, 21, ::typy::GetPyObject(p_poss));
	PyTuple_SET_ITEM(result, 22, ::typy::GetPyObject(p_pyd));
	PyTuple_SET_ITEM(result, 23, ::typy::GetPyObject(p_pyl));
	PyTuple_SET_ITEM(result, 24, ::typy::GetPyObject(p_pyv1));
	PyTuple_SET_ITEM(result, 25, ::typy::GetPyObject(p_pyv2));
	PyTuple_SET_ITEM(result, 26, ::typy::GetPyObject(p_sd));
	PyTuple_SET_ITEM(result, 27, ::typy::GetPyObject(p_sl));
	PyTuple_SET_ITEM(result, 28, ::typy::GetPyObject(p_v0));
	PyTuple_SET_ITEM(result, 29, ::typy::GetPyObject(p_v1));
	PyTuple_SET_ITEM(result, 30, ::typy::GetPyObject(p_v2));
	PyTuple_SET_ITEM(result, 31, ::typy::GetPyObject(p_v3));
	PyTuple_SET_ITEM(result, 32, ::typy::GetPyObject(p_v4));
	PyTuple_SET_ITEM(result, 33, ::typy::GetPyObject(p_vd));
	PyTuple_SET_ITEM(result, 34, ::typy::GetPyObject(p_vl));
	return result;
}
...
TYPY_GETSET(Fighter, p_ed, Dict(int64 -> Corpus));
...
TYPY_GETSET(Fighter, p_posll, List(VLVector2));
TYPY_GETSET(Fighter, p_poss, Dict(int64 -> Vector2));
...
TYPY_GETSET(Fighter, p_v0, Variant(Integer, Vector2, Float, Bytes));
...
template <> PyGetSetDef Object<Fighter>::GetSet[] = {
	...
	{"v0", (getter)Get_p_v0, (setter)Set_p_v0, "Property v0"},
