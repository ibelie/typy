...
int VfisVector2::Visit(visitproc visit, void* arg) {
...
PyObject* VfisVector2::Json(bool slim) {
	if (!slim || _tag != 0) {
		switch (_tag) {
...
VfisVector2* VfisVector2::FromJson(PyObject* json) {
	VfisVector2* object = new VfisVector2;
