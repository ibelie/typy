...
def _printFighters(fighter1, fighter2, fighter3, fighter4, fighter5):
	...
	print "pos.m\t", "\t", fighter1.pos.m, "\t\t", fighter2.pos.m, "\t\t", fighter3.pos.m, "\t\t", fighter4.pos.m, "\t\t", fighter5.pos.m
	...
	print "posl[0].m\t", fighter1.posl[0].m, "\t\t", fighter2.posl[0].m, "\t\t", fighter3.posl[0].m, "\t\t", fighter4.posl[0].m, "\t\t", fighter5.posl[0].m
	...
	print "poss[321].m\t", fighter1.poss[321].m, "\t\t", fighter2.poss[321].m, "\t\t", fighter3.poss[321].m, "\t\t", fighter4.poss[321].m, "\t\t", fighter5.poss[321].m
	...
	print "v3.m\t", "\t", fighter1.v3.m, "\t\t", fighter2.v3.m, "\t\t", fighter3.v3.m, "\t\t", fighter4.v3.m, "\t\t", fighter5.v3.m
	...
	print "vl[3].m\t", "\t", fighter1.vl[3].m, "\t\t", fighter2.vl[3].m, "\t\t", fighter3.vl[3].m, "\t\t", fighter4.vl[3].m, "\t\t", fighter5.vl[3].m
...
def test_cpy():
	...
	ClearTypes()
	if 'test_case' in sys.modules:
		del sys.modules['test_case']
